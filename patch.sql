...
ALTER TABLE `setlists` ADD `is_published` integer DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE `setlists` ADD `cover_image_id` text;CREATE TABLE `drive_assets` (
	`id` text PRIMARY KEY NOT NULL,
	`user_id` text NOT NULL,
...
--> statement-breakpoint
ALTER TABLE `projects` ADD `project_type` text(20) DEFAULT 'backing_track' NOT NULL;ALTER TABLE `sessions` ADD `ip_address` text;--> statement-breakpoint
ALTER TABLE `sessions` ADD `user_agent` text;CREATE TABLE `user_prefs` (
