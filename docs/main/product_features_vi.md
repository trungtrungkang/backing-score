...
> **Trạng thái:** Đã triển khai (Phase 1-3) | Bản địa hóa nội dung: Đang thiết kế
...
### 14.2 Trang Hướng Tới Người Dùng
- `/wiki` — Trung tâm bách khoa với các thẻ thể loại, ô tìm kiếm, và link "Quản lý nội dung" cho editor
- `/wiki/artists/[slug]` — Tiểu sử nghệ sỹ + dự án thực hành liên quan
- `/wiki/instruments/[slug]` — Hồ sơ nhạc cụ + lọc sheet thực hành
- `/wiki/compositions/[slug]` — Chi tiết tác phẩm + nút "Thực hành ngay"
- `/wiki/genres/[slug]` — Tổng quan thể loại + thể loại con + tác phẩm liên quan

### 14.3 Trình Soạn Thảo Rich Text (TipTap)
...
### 14.6 Bản Địa Hóa Nội Dung (Đang thiết kế)
