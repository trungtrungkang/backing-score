    ...
    <div className="min-h-screen bg-background dark:bg-[#0E0E11] text-foreground dark:text-white selection:bg-[#C8A856]/30 overflow-hidden font-sans">
      ...
      <main className="relative pt-32 pb-24 md:pt-48 md:pb-32 px-6 lg:px-12 flex flex-col items-center text-center">
        ...
        <div className="relative z-10 max-w-5xl w-full flex flex-col items-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 text-sm font-bold text-zinc-700 dark:text-zinc-300 mb-8 shadow-sm backdrop-blur-md">
            ...
            Public Beta 3.0 • The Play-Along Revolution
          </div>
          ...
          <h1 className="text-[3rem] sm:text-[4rem] lg:text-[5.5rem] font-black tracking-tight mb-8 leading-[1.05] text-zinc-900 dark:text-white">
            ...
            <span className="bg-gradient-to-r from-[#C8A856] via-amber-400 to-orange-400 bg-clip-text text-transparent px-2">
              Music Ecosystem.
            </span>
          </h1>
          
          <p className="text-lg md:text-2xl text-zinc-600 dark:text-zinc-400 font-medium max-w-3xl mb-12 leading-relaxed">
            Stop watching, start playing. <strong>Backing & Score</strong> is your ultimate play-along library and interactive academy. Play your favorite tracks or master your instrument with real-time pitch detection.
          </p>
        ...
        <div className="max-w-6xl mx-auto flex flex-col gap-32">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="aspect-square bg-gradient-to-tr from-zinc-200 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 rounded-3xl p-8 relative overflow-hidden flex items-center justify-center border border-zinc-200 dark:border-white/5 shadow-2xl shadow-black/5 dark:shadow-none transition-transform hover:-translate-y-2 duration-500">
                 ...
                 <div className="w-[80%] h-[80%] bg-white dark:bg-zinc-950 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 p-8 flex flex-col items-center justify-center gap-6 relative z-10">
                   ...
                   <div className="text-center">
                     <div className="text-lg font-bold text-zinc-900 dark:text-white mb-2">Analyzing Pitch...</div>
                     <div className="text-sm text-zinc-500 dark:text-zinc-400">Waiting for C4</div>
                   </div>
            ...
            <div className="w-full md:w-1/2 order-1 md:order-2 flex flex-col items-start text-left">
              ...
              <h2 className="text-3xl md:text-5xl font-black mb-6 text-zinc-900 dark:text-white">The Magic of <br/>Wait Mode.</h2>
              <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mb-8">
                Enter Acapella Practice. In Wait Mode, backing tracks are muted so you can focus entirely on your instrument. Connected via Microphone or MIDI, our Audio Engine analyzes your pitch in real-time. The sheet music only advances when you play the exact correct note. Master every measure with deliberate practice.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full md:w-1/2 flex flex-col items-start text-left">
              ...
              <h2 className="text-3xl md:text-5xl font-black mb-6 text-zinc-900 dark:text-white">Immersive <br/>Masterclasses.</h2>
              <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mb-8">
                Say goodbye to passive video lessons. Step into our Academy and learn from world-class creators through truly interactive courses. The curriculum drops you right into the sheet music, scoring your performance progressively as you learn.
              </p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="aspect-square bg-gradient-to-tr from-zinc-200 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 rounded-3xl p-8 relative overflow-hidden flex items-center justify-center border border-zinc-200 dark:border-white/5 shadow-2xl shadow-black/5 dark:shadow-none transition-transform hover:-translate-y-2 duration-500">
                 ...
                 <div className="w-4/5 bg-white dark:bg-zinc-950 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 p-6 flex flex-col gap-4 relative z-10">
                   <div className="flex items-center justify-between mb-2">
                     <span className="font-bold text-sm text-zinc-900 dark:text-zinc-100">Mixer Console</span>
                     <AudioWaveform className="w-4 h-4 text-purple-500" />
                   </div>
                   {[
                     { name: "Rhythm Drums", active: true },
                     { name: "Lead Guitar", active: false }, // muted
                     ...
                     <div key={idx} className={`flex items-center gap-3 p-2 rounded border ${trk.active ? 'bg-zinc-50 dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800' : 'bg-red-50 dark:bg-red-950/30 border-red-200 dark:border-red-900/50'}`}>
                       ...
                       <div className="text-xs font-semibold flex-1 truncate dark:text-zinc-300">{trk.name}</div>
            ...
            <div className="w-full md:w-1/2 order-1 md:order-2 flex flex-col items-start text-left">
              ...
              <h2 className="text-3xl md:text-5xl font-black mb-6 text-zinc-900 dark:text-white">Multi-Track <br/>Isolation.</h2>
              <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mb-8">
                Every song in our library is a professional multi-track recording. Want to practice the Piano part? Just mute the Piano stem to isolate the band, and you become the star player. You have full control over the studio mix.
              </p>
            </div>
          </div>
      ...
      <section className="relative z-20 py-32 px-6">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-zinc-900 to-black dark:from-[#15151A] dark:to-black rounded-[3rem] p-12 md:p-20 text-center border border-zinc-800 shadow-2xl relative overflow-hidden flex flex-col items-center">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight relative z-10">Stop playing <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-400 to-zinc-600 italic">alone.</span></h2>
          <p className="text-xl text-zinc-400 mb-12 max-w-2xl relative z-10 font-medium">Be among the first to experience the ultimate interactive play-along platform.</p>
      ...
      <footer className="w-full border-t border-zinc-200 dark:border-white/5 py-12 text-center text-zinc-500 dark:text-zinc-600 text-sm bg-zinc-50 dark:bg-transparent relative z-20">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 gap-6">
          ...
          <p>© 2026 Backing & Score. The Interactive Music Network.</p>
        </div>
      </footer>
    </div>
  );
