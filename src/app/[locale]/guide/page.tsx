...
import { Play, Music, Sparkles, CheckCircle2, Circle, GraduationCap, PenTool, Pause, AudioWaveform, Mic2 } from "lucide-react";
      ...
      <main className="pt-24 pb-32 px-6 max-w-5xl mx-auto space-y-32">
        ...
        <section className="text-center space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C8A856] via-amber-400 to-orange-400">{t("heroTitleHighlight")}</span>
          </h1>
        ...
        <section className="space-y-8">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 space-y-6">
              ...
              <h2 className="text-3xl font-bold text-white">{t("s1Title")}</h2>
              <p className="text-zinc-400 leading-relaxed">{t("s1Body")}</p>
            </div>
            ...
            <div className="flex-1 w-full bg-zinc-900 rounded-2xl border border-white/10 shadow-2xl overflow-hidden p-6 flex flex-col justify-center items-center relative aspect-video">
               ...
               <div className="absolute top-4 left-4 right-4 flex justify-between items-center opacity-80">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-emerald-400 drop-shadow-md">{t("s1Listening")}</span>
                  </div>
                  <span className="bg-[#C8A856] text-black text-xs font-bold px-2 py-1 rounded">{t("s1WaitMode")}</span>
               </div>
               ...
               <div className="absolute bottom-6 bg-red-500/20 border border-red-500/50 backdrop-blur-md px-4 py-2 rounded-xl flex items-center gap-3 animate-bounce">
                 ...
                 <div>
                   <div className="text-red-500 font-bold text-sm tracking-widest text-shadow">{t("s1PitchError")}</div>
                   <div className="text-red-300 text-xs">{t("s1WaitNote")}</div>
                 </div>
               </div>
            </div>
          </div>
        ...
        <section className="space-y-8">
          <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
            <div className="flex-1 space-y-6">
              ...
              <h2 className="text-3xl font-bold text-white">{t("s2Title")}</h2>
              <p className="text-zinc-400 leading-relaxed">{t("s2Body")}</p>
            </div>
        ...
        <section className="space-y-8">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1 space-y-6">
              ...
              <h2 className="text-3xl font-bold text-white">{t("s3Title")}</h2>
              <p className="text-zinc-400 leading-relaxed">{t("s3Body")}</p>
            </div>
            ...
            <div className="flex-1 w-full bg-zinc-950 rounded-2xl border border-white/10 shadow-2xl overflow-hidden flex flex-col relative aspect-video">
               <div className="h-10 border-b border-white/10 bg-zinc-900 flex items-center px-4 gap-2">
                 ...
                 <div className="px-2 py-1 rounded bg-purple-500/20 text-purple-400 border border-purple-500/30 text-[10px] font-bold flex items-center gap-1">
                   <Music className="w-3 h-3" /> {t("s3InsertMusicXML")}
                 </div>
               </div>
               <div className="flex-1 p-6 flex flex-col gap-4">
                 ...
                 <div className="w-full p-4 border-2 border-dashed border-purple-500/40 bg-purple-500/5 rounded-xl flex items-center justify-between mt-2">
                   ...
                   <div className="flex items-center gap-2">
                     <span className="text-[10px] text-white/50 font-bold uppercase">{t("s3EnforceWaitMode")}</span>
        ...
        <section className="space-y-8">
          <div className="bg-[#15151A] border border-white/10 rounded-3xl p-8 md:p-12 text-center flex flex-col items-center">
             ...
             <h2 className="text-3xl font-bold text-white mb-4">{t("s4Title")}</h2>
             <p className="text-zinc-400 max-w-2xl text-lg mb-10">{t("s4Body")}</p>
             ...
             <div className="w-full max-w-lg bg-black border border-white/10 rounded-2xl p-6 shadow-2xl flex flex-col gap-4">
                {[
                  { nameKey: "trackDrums", vol: "80%", color: "bg-blue-500" },
                  { nameKey: "trackPiano", vol: "0%", color: "bg-zinc-600", muted: true },
                  { nameKey: "trackBass", vol: "60%", color: "bg-emerald-500" }
                ].map((track, i) => (
                  <div key={i} className="flex items-center gap-4 bg-white/5 p-3 rounded-xl border border-white/5">
                     ...
                     <span className={`w-32 text-left text-sm font-bold truncate ${track.muted ? 'text-white/30' : 'text-white'}`}>{t(track.nameKey as any)}</span>
